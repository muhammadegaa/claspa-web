...
- AI notes with one tap
- Quizzes on pause (opt-in, not annoying)
- SM-2 spaced repetition mastery tracking
- Cross-lecture concept connections
- Screenshot capture for diagrams/slides
- BYOK — bring your own API key

It's $9 one-time for the core tool. No subscription traps.

Would love your feedback — especially on the quiz timing and what other platforms you'd want supported (Coursera, YouTube, etc.)

## Gallery Image Descriptions (4 images needed)
1. "Auto-capture" — Buddy pill on Udemy page with transcript grabbed, showing "790 words captured"
2. "AI Notes" — Notes card open with structured markdown notes
3. "Quiz on Pause" — Quiz card with multiple choice question
4. "Mastery Tracking" — Popup mastery tab showing concept breakdown
...
## Topics
- Note-taking, Learning, AI, Chrome Extension, Spaced Repetition, Udemy
